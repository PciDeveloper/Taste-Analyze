...
<tr>
	<th class="center"><input type="checkbox" name="allchk" value="1" onclick="Common.allCheck('chk[]');" /></td>
 ...
 <tbody>
<?
$notice_qry = $db->_execute("select * from sw_board where code='$code' AND notice='Y' order by ref desc, re_step asc");
$i = 1;
...
<tr>
	...
	<td><img src="/img/icon/notice _bt.png" /></td>
