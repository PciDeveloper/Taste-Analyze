...
<tr>
	<th>제목</th>
	<td><input type="text" name="title" class="input-small" value="<?=$row['title']?>" style="width:556px;"/></td>
</tr>

<tr>
	<th>내용</th>
	<td><input type="text" name="content" class="input-small" value="<?=$row['content']?>" style="width:556px;"/></td>
</tr>
...
<tr>
	<th>단맛</th>
	<td>
		<input type="text" name="swhappy" id="swhappy" class="input-small hap" value="<?=$row['swhappy']?>" exp="수치를"/>
		<input type="text" name="swsad" id="swsad" class="input-small hap" value="<?=$row['swsad']?>" exp="수치를"/>
		<input type="text" name="swangry" id="swangry" class="input-small hap" value="<?=$row['swangry']?>" exp="수치를"/>
		<input type="text" name="swsurpr" id="swsurpr" class="input-small hap" value="<?=$row['swsurpr']?>" exp="수치를"/>
		<input type="text" name="swscar" id="swscar" class="input-small hap" value="<?=$row['swscar']?>" exp="수치를"/>
		<input type="text" name="swdisgus" id="swdisgus" class="input-small hap" value="<?=$row['swdisgus']?>" exp="수치를"/>
	</td>
</tr>
...
<tr>
	<th>쓴맛</th>
	<td>
		<input type="text" name="bithappy" id="bithappy" class="input-small hap" value="<?=$row['bhappy']?>" exp="수치를"/>
		<input type="text" name="bitsad" id="bitsad" class="input-small hap" value="<?=$row['bsad']?>" exp="수치를"/>
		<input type="text" name="bitangry" id="bitangry" class="input-small hap" value="<?=$row['bangry']?>" exp="수치를"/>
		<input type="text" name="bitsurpr" id="bitsurpr" class="input-small hap" value="<?=$row['bsurpr']?>" exp="수치를"/>
		<input type="text" name="bitscar" id="bitscar" class="input-small hap" value="<?=$row['bscar']?>" exp="수치를"/>
		<input type="text" name="bitdisgus" id="bitdisgus" class="input-small hap" value="<?=$row['bdisgus']?>" exp="수치를"/>
	</td>
</tr>
...
<tr>
	<th>짠맛</th>
	<td>
		<input type="text" name="sthappy" id="sthappy" class="input-small hap" value="<?=$row['slthappy']?>" exp="수치를"/>
		<input type="text" name="stsad" id="stsad" class="input-small hap" value="<?=$row['sltsad']?>" exp="수치를"/>
		<input type="text" name="stangry" id="stangry" class="input-small hap" value="<?=$row['sltangry']?>" exp="수치를"/>
		<input type="text" name="stsurpr" id="stsurpr" class="input-small hap" value="<?=$row['sltsurpr']?>" exp="수치를"/>
		<input type="text" name="stscar" id="stscar" class="input-small hap" value="<?=$row['sltscar']?>" exp="수치를"/>
		<input type="text" name="stdisgus" id="stdisgus" class="input-small hap" value="<?=$row['sltdisgus']?>" exp="수치를"/>
	</td>
</tr>
...
<tr>
	<th>신맛</th>
	<td>
		<input type="text" name="sohappy" id="sohappy" class="input-small hap" value="<?=$row['sourhappy']?>" exp="수치를"/>
		<input type="text" name="sosad" id="sosad" class="input-small hap" value="<?=$row['soursad']?>" exp="수치를"/>
		<input type="text" name="soangry" id="soangry" class="input-small hap" value="<?=$row['sourangry']?>" exp="수치를"/>
		<input type="text" name="sosurpr" id="sosurpr" class="input-small hap" value="<?=$row['soursurpr']?>" exp="수치를"/>
		<input type="text" name="soscar" id="soscar" class="input-small hap" value="<?=$row['sourscar']?>" exp="수치를"/>
		<input type="text" name="sodisgus" id="sodisgus" class="input-small hap" value="<?=$row['sourdisgus']?>" exp="수치를"/>
	</td>
</tr>
...
<tr>
	<th id="spicy">매운맛</th>
	<td>
		<input type="text" name="sphappy" id="sphappy" class="input-small hap" value="<?=$row['spchappy']?>" exp="수치를"/>
		<input type="text" name="spsad" id="spsad" class="input-small hap" value="<?=$row['spcsad']?>" exp="수치를"/>
		<input type="text" name="spangry" id="spangry" class="input-small hap" value="<?=$row['spcangry']?>" exp="수치를"/>
		<input type="text" name="spsurpr" id="spsurpr" class="input-small hap" value="<?=$row['spcsurpr']?>" exp="수치를"/>
		<input type="text" name="spscar" id="spscar" class="input-small hap" value="<?=$row['spcscar']?>" exp="수치를"/>
		<input type="text" name="spdisgus" id="spdisgus" class="input-small hap" value="<?=$row['spcdisgus']?>" exp="수치를"/>
	</td>
</tr>
...
// 해당하는 수치가 없을 경우는 0 으로 표기
   for (var i = 0; i < vals1.length; i++) {
       var taste = tasty1.filter(function(item){return item.taste == vals1[i].taste && item.mood == vals1[i].mood}).find(function(item){return vals1[i].val >= item.start && vals1[i].val <= item.end});
       vals1[i].step = (taste && taste.step) || 0;
   }
	 for (var i = 0; i < vals2.length; i++) {
       var taste = tasty2.filter(function(item){return item.taste == vals2[i].taste && item.mood == vals2[i].mood}).find(function(item){return vals2[i].val >= item.start && vals2[i].val <= item.end});
       vals2[i].step = (taste && taste.step) || 0;
   }

	 for (var i = 0; i < vals3.length; i++) {
				var taste = tasty3.filter(function(item){return item.taste == vals3[i].taste && item.mood == vals3[i].mood}).find(function(item){return vals3[i].val >= item.start && vals3[i].val <= item.end});
				vals3[i].step = (taste && taste.step) || 0;
		}

	 for (var i = 0; i < vals4.length; i++) {
       var taste = tasty4.filter(function(item){return item.taste == vals4[i].taste && item.mood == vals4[i].mood}).find(function(item){return vals4[i].val >= item.start && vals4[i].val <= item.end});
       vals4[i].step = (taste && taste.step) || 0;
   }

	 for (var i = 0; i < vals5.length; i++) {
       var taste = tasty5.filter(function(item){return item.taste == vals5[i].taste && item.mood == vals5[i].mood}).find(function(item){return vals5[i].val >= item.start && vals5[i].val <= item.end});
       vals5[i].step = (taste && taste.step) || 0;
   }
