...
$navi = "상품관리  > 상품 문의 ";
 ...
 $sqry = sprintf("select a.*, b.name as gname, b.category as gcategory from %s a, %s b where a.gidx=b.idx %s", SW_BOOKING, SW_GOODS, $AddW);
...
<tr onMouseOver="this.style.background='#eef3f7';" onMouseOut="this.style.background='';">
  <td><input type="checkbox" name="chk[]" value="<?=$row['idx']?>" /></td>
	...
	<td>
    <button type="button" onclick="javascript:location.href='./booking_status.php?encData=<?=$encData?>'" class="btn btn-white btn-xs btn-info"/>예약내역</button>
    &nbsp;&nbsp;
