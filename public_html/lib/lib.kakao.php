...
class KAKAO_LOGIN{
	...
	private $client_id		= 'e162e0ff41213acf417bc0a944197c98';			// 발급받은 클라이언트 아이디
	private $client_secret	= '';			// 발급받은 클라이언트 시크릿키

	private $returnURL		= 'http://cpgjaspt.cafe24.com/member/kakao_login_callback.php';			// 콜백 받을 URL ( 네이버에 등록된 콜백 URI가 우선됨)
