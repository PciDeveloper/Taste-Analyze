...
$sqry = sprintf("select * from %s where buse <> 'N' %s  ", SW_BOARD, $AddW);
...
<tr onMouseOver="this.style.background='#eef3f7';" onMouseOut="this.style.background='';">
	...
	<td style="text-align:left; padding-left:20px;"><a href="../board/board.view.php?encData=<?=$encData?>&code=<?=$row['code']?>"><?=$row['title']?></a></td>   
	<td><?=$row['regdt']?></td>   
</tr>
<?
}
