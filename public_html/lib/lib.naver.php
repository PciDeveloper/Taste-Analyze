...
class Naver{
	...
	private $client_id		= '7mYQGw5I_rGkwLDuKKaa';			// 네이버에서 발급받은 클라이언트 아이디
	private $client_secret	= 'qXPotrN0j1';			// 네이버에서 발급받은 클라이언트 시크릿키

	private $returnURL		= 'http://cpgjaspt.cafe24.com/member/naver_login_callback.php';			// 콜백 받을 URL ( 네이버에 등록된 콜백 URI가 우선됨)
