...
<tr>
	...
	<td><a href="<?=$board->getLink($encData);?>" class="tit"><?=$board->getCateView($notice_row['cate'])?> <?=getCutString($notice_row['title'], $board->info['cutstr'])?> <?=$board->getIconNew($notice_row['regdt'])?></a></td>
